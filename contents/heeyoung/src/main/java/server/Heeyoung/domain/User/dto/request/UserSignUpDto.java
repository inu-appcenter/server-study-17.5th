...
public class UserSignUpDto {
    ...
    @Schema(description = "로그인 비밀번호", example = "wlkejf392!")
    private String password;

    @NotBlank(message = "이메일은 필수 입력 값입니다.")
    @Email(message = "이메일 형식이 올바르지 않습니다.")
    @Schema(description = "이메일", example = "heeyoung@gmail.com")
    ...
    @Schema(description = "실명", example = "김희영")
    private String name;

    @Size(max = 20, message = "닉네임은 20자를 넘을 수 없습니다.")
    @Schema(description = "닉네임", example = "희영")
